...
<p align="center">
  <a href="#a-storage-platform-not-a-cache">Platform</a> ·
...
## A storage platform, not a cache
...
<p align="center">
  <img src="docs/diagrams/platform.svg" alt="The Forebay platform surface" width="100%">
</p>
...
| --- | --- | --- |
| Snapshots and instant clones | Yes, mature | Planned · [0012](docs/rfcs/0012-dataset-object-model.md) |
| Replication and disaster recovery | Yes, mature | Planned · [0006](docs/rfcs/0006-durable-backend-driver-contract.md) |
| Thin provisioning and compression | Yes, mature | Planned · [0006](docs/rfcs/0006-durable-backend-driver-contract.md) |
| Encryption at rest and in flight | Yes, mature | Planned · [0016](docs/rfcs/0016-multi-tenancy-qos-and-security.md) |
| QoS, quotas, multi-tenancy, RBAC | Yes, mature | Planned · [0016](docs/rfcs/0016-multi-tenancy-qos-and-security.md) |
| Audit and capacity reporting | Yes, mature | Planned · [0017](docs/rfcs/0017-observability.md) |
| Non-disruptive upgrade | Yes, mature | Planned · [0019](docs/rfcs/0019-upgrades-and-operations.md) |
| File, object and block access | Yes, mature | Specified · [0021](docs/rfcs/0021-single-copy-multi-protocol.md) |
...
| | A mature array platform | Forebay |
| --- | --- | --- |
| Capacity that appears from idle compute nodes and returns itself | No. It sells you the array | Specified · [0005](docs/rfcs/0005-capacity-pools-and-elastic-leases.md) |
| Placement that follows the accelerator, by GPU, NUMA and PCIe topology | No. It sees its own media only | Planned · [0003](docs/rfcs/0003-topology-model.md) |
| Telling the scheduler where the data already is | No. It has no scheduler to talk to | Planned · [0022](docs/rfcs/0022-data-aware-scheduling.md) |
| Pre-filling a rack before the pod is admitted | No | Planned · [0022](docs/rfcs/0022-data-aware-scheduling.md) |
| GB/s per GPU and GPU hours lost to storage, as the unit of management | No. It reports IOPS | Planned · [0024](docs/rfcs/0024-efficiency-accounting.md) |
| Prefetch driven by dataset manifests and dataloader hints | No | Planned · [0011](docs/rfcs/0011-prefetch-and-dataset-manifests.md) |
| Checkpoint fast-ack with a stated durability policy | Partially, generically | Planned · [0013](docs/rfcs/0013-checkpoint-path.md) |
| Datasets, versions and experiments instead of volumes and LUNs | No | Planned · [0012](docs/rfcs/0012-dataset-object-model.md) |
| Runs on the storage you already bought, from any vendor | No, by design | Specified · [0006](docs/rfcs/0006-durable-backend-driver-contract.md) |
